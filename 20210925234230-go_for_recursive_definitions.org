...
This isn't special to typed languages, or even software. If you have relationship A -> B, and A and B are really similar, see if you can go for relationship A -> A. You can add the pattern-matching and restrictions a la carte.
